...
export function LanguageServersSection(): React.JSX.Element {
  ...
  return (
    <>
      ...
      <p className="set-note">
        Orrery talks to language servers already installed on this machine; it does not bundle
        them. A language with no server still gets syntax highlighting, brackets and folding —
        it just gets no diagnostics.
      </p>
